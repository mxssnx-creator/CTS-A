...
export const BUILTIN_PRESETS: SettingsPreset[] = [
  ...
  {
    id: "vst-working-01",
    label: "VST Working 01",
    blurb: "VST-02 · 50/300 · short 0.48/0.75 · trail 1.5 · Block 1,3–6 shared 1.5/0.2 · intern 96 · protect pinned",
    builtin: true,
    patch: {
      activeConnId: "bingx-vst-02",
      symbolCount: 50,
      ...
      blockConfig: {
        ...
        lastNProgress: {
          ...
          evalNs: [...DEFAULT_LAST_N_PROGRESS.evalNs],
          validNs: [...DEFAULT_LAST_N_PROGRESS.validNs],
          disableNs: [...DEFAULT_LAST_N_PROGRESS.disableNs],
        },
      },
      thresholds: {
        ...DEFAULT_THRESHOLDS,
      ...
      shortProgress: {
        ...
        indications: [...DEFAULT_SHORT_PROGRESS.indications],
        lastParts: [...DEFAULT_SHORT_PROGRESS.lastParts],
        activityWindows: [...DEFAULT_SHORT_PROGRESS.activityWindows],
        minTpAtr: 0.48,
        minSlOfTp: 0.75,
        maxTpAtr: 0.6,
        evalHours: 20,
      ...
      evalLastNs: [50, 15, 12],
      lastN: 15,
      lastNs: { picks: 15, lanes: 15, last: 15, ongoing: 15, next: 15, combos: 15 },
      lastNLinked: true,
      hedgeMode: true,
      marginMode: "cross",
      useMaxLeverage: true,
