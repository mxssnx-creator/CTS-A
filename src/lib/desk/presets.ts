...
export const BUILTIN_PRESETS: SettingsPreset[] = [
  ...
  },
  {
    id: "stable-01",
    label: "Stable 01",
    blurb: "x01 live snapshot · 50 · trailing/atr · short 0.42/1.7 · Block 1–6 parallel Active · min PF 1.8",
    builtin: true,
    patch: {
      activeConnId: "bingx-x01",
      symbolCount: 50,
  ...
  },
  {
    id: "stable-02",
    label: "Stable 02",
    blurb: "x01 · 120 · short 0.42/1.7 · Axis full rungs · Block 1–6 0.4 · PF 1.35/1.0/1.15/1.2 · short 0.95/0.7",
    builtin: true,
    patch: {
      activeConnId: "bingx-x01",
      symbolCount: 120,
