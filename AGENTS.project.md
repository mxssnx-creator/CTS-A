...
- Block: additive **0.2**, shared **1.5**, overall **1.5**, maxMul **2.5**, counts 1–6 independent. Axis volume **3.0×** a normal position (live depth 2). **0.08 is forbidden** (Axis leftover that killed live).
